...
// ─── Out-of-line definitions (one translation unit must include SystemState.cpp)
// Declared here for header-only convenience in small projects; move to a .cpp
// if link-time errors appear.
inline SystemState       SharedState::_state{};
inline SemaphoreHandle_t SharedState::_mutex = nullptr;
